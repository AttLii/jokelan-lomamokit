...
export const stringTranslationSchema = z.object({
  ...
  "generic.map.consent": z.string(),
  "cookie.notification.open.label": z.string(),
  "cookie.notification.title": z.string(),
  "cookie.notification.description": z.string(),
  "cookie.notification.category.on": z.string(),
  "cookie.notification.category.off": z.string(),
  "cookie.notification.category.all": z.string(),
